...
This repository contains my data analytics and database projects, focusing on SQL querying, data warehousing, and BI dashboarding to solve real business problems.
...
* **Databases & Modeling:** SQL (Oracle, MySQL, PostgreSQL), Visio
* **Business Intelligence:** Power BI, Power Query, Excel
* **Systems Analysis:** Requirement Gathering, ERD Design, Process Flowcharts
